...
import com.crecg.staffshield.adapter.BillCenterBankCardRecycleAdapter;
import com.crecg.staffshield.adapter.BillCenterRegularFinancialRecycleAdapter;
...
public class BillCenterRegularFinancialFragment extends Fragment {
    ...
    private BillCenterRegularFinancialRecycleAdapter regularFinancialRecycleAdapter;


    public static BillCenterRegularFinancialFragment newInstance(String param1) {
        BillCenterRegularFinancialFragment fragment = new BillCenterRegularFinancialFragment();
...
//        tv_empty.setText("测试...");
    ...
    private void initRecyclerView() {
        ...
        regularFinancialRecycleAdapter = new BillCenterRegularFinancialRecycleAdapter(context, list);
        recycler_view.setAdapter(regularFinancialRecycleAdapter);
//        //添加动画
    ...
    private void initLoadMoreListener() {
        recycler_view.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE && lastVisibleItem + 1 == regularFinancialRecycleAdapter.getItemCount() && firstVisibleItem != 0) {
                    if (list.size() == 0) {
                        return;
                    }
                    currentPage++;
