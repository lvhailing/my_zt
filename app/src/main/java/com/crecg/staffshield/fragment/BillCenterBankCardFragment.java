...
public class BillCenterBankCardFragment extends Fragment {
    ...
    private BillCenterBankCardRecycleAdapter billCenterBankCardRecycleAdapter;


    public static BillCenterBankCardFragment newInstance(String param1) {
        BillCenterBankCardFragment fragment = new BillCenterBankCardFragment();
...
//        tv_empty.setText("测试...");
    ...
    private void initRecyclerView() {
        ...
        billCenterBankCardRecycleAdapter = new BillCenterBankCardRecycleAdapter(context, list);
        recycler_view.setAdapter(billCenterBankCardRecycleAdapter);
//        //添加动画
    ...
    private void initLoadMoreListener() {
        recycler_view.setOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE && lastVisibleItem + 1 == billCenterBankCardRecycleAdapter.getItemCount() && firstVisibleItem != 0) {
                    if (list.size() == 0) {
                        return;
                    }
                    currentPage++;
