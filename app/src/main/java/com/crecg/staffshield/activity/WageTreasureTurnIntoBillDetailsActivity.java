...
public class WageTreasureTurnIntoBillDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        baseSetContentView(R.layout.activity_wage_treasure_turn_into_bill_details);
        ...
        btn_complete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if ("1".equals(whereToEnterFlag)) {
                    intent = new Intent(WageTreasureTurnIntoBillDetailsActivity.this, MainActivity.class);
                    intent.putExtra("homeFlag", "1");
                    intent.putExtra("homeFlag", "1");
                    intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TASK | Intent.FLAG_ACTIVITY_NEW_TASK);
                } else if ("2".equals(whereToEnterFlag)) {
                    intent = new Intent(WageTreasureTurnIntoBillDetailsActivity.this, SalaryTreasureDetailActivity.class);
                    intent.putExtra("homeFlag", "1");
                }
