...
public class SelectPhotoDialog extends Dialog implements DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private void initView(View mView) {
        txtAblum = (TextView) mView.findViewById(R.id.dialog_tv_album);
        txtCamera = (TextView) mView.findViewById(R.id.dialog_tv_camera);
        txtCancel = (TextView) mView.findViewById(R.id.dialog_tv_cancel);
