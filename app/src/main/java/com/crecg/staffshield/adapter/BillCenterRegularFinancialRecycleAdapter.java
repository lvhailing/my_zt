...
/**
 * 账单中心 -- 定期理财 列表  RecyclerView的 Adapter 类
 */
public class BillCenterRegularFinancialRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BillCenterRegularFinancialRecycleAdapter(Context context, ArrayList<BillCenterListData> list) {
        mContext = context;
        this.list = list;
