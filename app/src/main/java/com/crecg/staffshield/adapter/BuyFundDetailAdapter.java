...
public class BuyFundDetailAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private List<BuyFundProgressModel> list;
    private Context mContext;


    public BuyFundDetailAdapter(Context context, List<BuyFundProgressModel> list) {
        mContext = context;
        this.list = list;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        BuyFundProgressModel item = list.get(position);
