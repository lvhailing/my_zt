...
/**
 * 账单中心 -- 工资宝 列表  RecyclerView的 Adapter 类
 */
public class BillCenterSalaryTreasureRecycleAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public BillCenterSalaryTreasureRecycleAdapter(Context context, ArrayList<BillCenterListData> list) {
        mContext = context;
        this.list = list;
